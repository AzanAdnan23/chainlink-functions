...
const StellarSdk = (await import("https://esm.sh/@stellar/stellar-sdk@latest"))
  .default; // Destructure the necessary components from StellarSdk
const {
  Keypair,
  Contract,
  SorobanRpc,
...
console.log(serverUrl, typeof serverUrl);
...
//     "GABNANU2Q7WF7RMSOIE3ZAHCV676RMATP3FM6FA57QTTWLQZHQOAQ3IS",
//     "39720000000012143",  // Adjusted sequence number from the given output
// );
